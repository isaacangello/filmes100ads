...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
        <div style="color: whitesmoke">Usuário : &nbsp;{{ Auth::user()->name }}</div>
    </div>
    <!-- Navbar Search
...
-->
    ...
    <!-- /#wrapper -->
<div class="container-fluid float-right" style="clear-side: both; margin-top: 10em;">
<footer class="sticky-footer footer container-fluid " style="width: 100%;">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            ...
            <span> © {{ $ano }} Copyright - Filmes sem ADS  </span>
        </div>
    </div>
</footer>
</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Deseja realmente deslogar?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Selecione "Logout" Pra confirmar a saida.</div>
...
@yield('javascript')
    ...
    <script type="text/javascript">
        $('.range-slider').jRange({
            ...
            to: 240,
            step: 1,
            scale: [30,60,100,120,180,200,240],
            format: '%s',
            width: 400,
            showLabels: true,
            snap: true
        });
        $('.slider').jRange('updateRange', '30,240');
    </script>
