             ...
             <table class="table table-responsive container-fluid" style="width: 100%;">
                 ...
                 <tr>
                     <td style="width: 30%;margin-right: 10px;padding-right: 0px;">
                         @if(file_exists('storage/capas/image'.$visualizar['id'].'.jpg'))
                             <img class="img-rounded img-responsive img-thumbnail" style="max-width: 150px !important; " src="{{ url('storage/capas/image'.$visualizar['id'].'.jpg') }}" alt="logo" />
                         @else
                             <img class="img-rounded img-responsive img-thumbnail" style="max-width: 150px !important; " src="{{ url('storage/capas/semcapa.jpg') }}" alt="logo" />
                         @endif
 ...
 @else
        ...
        <div class="col-xl-2 col-sm-2 mb-2" >
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-0">
                  @if(file_exists('storage/capas/image'.$post->id.'.jpg'))
                      <img src="{{ url('storage/capas/image'.$post->id.'.jpg') }}" alt="logo" />
                      @else
                      <img src="{{ url('storage/capas/semcapa.jpg') }}" alt="logo" />
                  @endif
              </div>
            </div>
    ...
    <!--inicio da paginaçao-->
        <div class="col-xl-12 col-sm-12 mb-12" style="margin-bottom: 20px;">
            <!--
                Algoritimo que gera lista de posts filtrados por categoria.
            -->
        @if ($cate_var)<!--if cate_var -->
            <ul class="pagination justify-content-center">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ route('index', ['pag' => ($pag - 1), 'categorias' => $cate_var ]) }}" tabindex="-1">Anterior</a>
                    </li>
                ...
                @for($i=1;$i<=5;$i++)
                    ...
                    @endif
                @endfor
                @if($pag == (ceil($total_regs/$exib_regs)) )
                    <li class="page-item disabled">
                        <a class="page-link" href="{{ route('index', ['pag' => ($pag + 1), 'categorias' => $cate_var ]) }}">Próximo</a>
                    </li>
                @else
                    <li class="page-item ">
                        <a class="page-link" href="{{ route('index', ['pag' => ($pag + 1), 'categorias' => $cate_var ]) }}">Próximo</a>
        ...
        @else<!-- if catevar-->
            ...
            <ul class="pagination justify-content-center">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ route('index', ['pag' => ($pag - 1)]) }}" tabindex="-1">Anterior</a>
                    </li>
            ...
            @endfor
                ...
                @if($pag == (ceil($total_regs/$exib_regs)) )
                    <li class="page-item disabled">
                        <a class="page-link" href="{{ route('index', ['pag' => ($pag + 1)]) }}">Próximo</a>
                    </li>
                @else
                    <li class="page-item ">
                        <a class="page-link" href="{{ route('index', ['pag' => ($pag + 1)]) }}">Próximo</a>
